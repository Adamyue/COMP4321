...
\begin{itemize}
    \item \textbf{Test Case 1.1: BFS and Page Limit}: The crawler uses a queue-based BFS traversal and stops when \texttt{len(visited)} reaches \texttt{max	extunderscore pages}.
